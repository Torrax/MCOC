...
shell.execute("wget -fq " .. REPOSITOTY .. "/apps/game_More_less.lua /home/apps/game_More_less.lua")
shell.execute("wget -fq " .. REPOSITOTY .. "/apps/game_One_armed_creeper.lua /home/apps/game_One_armed_creeper.lua")
shell.execute("wget -fq " .. REPOSITOTY .. "/apps/game_Roulette.lua /home/apps/game_Roulette.lua")
