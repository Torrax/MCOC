...
local function drawRightMenu()
    ...
    buffer.drawText(63, 2, 0xAAAAAA, "Output:")
...
local function drawRewards()
    buffer.drawText(6, 17, 0, "Pair of Adj Characters: " .. bet * 1 .. "  ")
...
local function drawStatic()
    ...
    buffer.drawText(6, 19, 0, "Get Three Symbols in a Row")
    buffer.drawText(70, 15, 0, 'Rate')
    ...
    if x >= 63 and x <= 84 then
        ...
        if y >= 23 and y <= 25 then
            ...
            if payed then
                ...
                if ratio > 0 then
                    message("You won " .. bet * ratio .. " Chips")
