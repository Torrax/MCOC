...
local function drawStatic()
    ...
    buffer.drawText(106, 3, 0xffffff, "Top")
    buffer.drawText(105, 7, 0xffffff, "Middle")
    buffer.drawText(105, 11, 0xffffff, "Bottom")
    buffer.drawText(29, 15, 0xffffff, "First 12")
    buffer.drawText(56, 15, 0xffffff, "Second 12")
    buffer.drawText(85, 15, 0xffffff, "Third 12")
    buffer.drawText(22, 19, 0xffffff, "1 to 18")
    buffer.drawText(37, 19, 0xffffff, "Even")
    buffer.drawText(80, 19, 0xffffff, "Odd")
    buffer.drawText(92, 19, 0xffffff, "19 to 36")
    ...
    buffer.drawText(92, 26, 0xffffff, "Roll")
    buffer.drawText(92, 30, 0xffffff, "Exit")
    buffer.drawText(52, 19, 0xffffff, "Red")
    buffer.drawText(65, 19, 0xffffff, "Black")
